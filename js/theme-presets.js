...
const ANSEM_COPY = {
    ...
    buyAdvance: 'BLACK BULLS ADVANCING', sellAdvance: 'GRIZZLIES ADVANCING',
    contestedState: 'FRONTLINE CONTESTED', quietState: 'FRONTLINE QUIET',
...
export const GENERIC_THEME = createThemeDefinition({
    ...
    ui: {
        ...
        copy: {
            ...
            buyAdvance: 'BUY FORCES ADVANCING', sellAdvance: 'SELL FORCES ADVANCING',
